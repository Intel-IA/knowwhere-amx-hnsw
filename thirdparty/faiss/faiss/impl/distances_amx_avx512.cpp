...
float
bf16_vec_inner_product_amx_ref(const void **pVect1v,const  void *pVect2v,const  void *qty_ptr, size_t nSize, size_t mSize, float * results_amx) {
    ...
    // float *results_avx512 = new float[nSize*mSize];
    // for(size_t i = 0; i < nSize; i++) {
    //     results_avx512[i] = InnerProductDistanceBf16AVX512(pVect1v[i], pVect2v, &qty);
    // }
